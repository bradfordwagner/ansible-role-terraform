# terraform-install Specification

## Purpose
Installs HashiCorp Terraform onto a host: downloading and checksum-verifying the Community release archive for a configurable version, unarchiving it into a versioned install directory, and symlinking the binary into a bin directory — for either system-wide or per-user (local) installs.
